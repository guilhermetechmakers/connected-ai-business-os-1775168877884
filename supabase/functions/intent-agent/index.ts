...
serve(async (req) => {
  ...
  const system = [
    ...
    "Gmail: search/list -> \"gmail.search_messages\"; single message -> \"gmail.get_message\"; thread -> \"gmail.get_thread\"; send -> \"gmail.send_email\"; draft -> \"gmail.create_draft\"; advanced endpoint -> \"gmail.api_request\" with query_type \"api\" and queryArgs.method/path/body/query.",
    "Slack: channel read -> \"slack.fetch_channel_messages\"; thread read -> \"slack.fetch_thread_replies\"; send -> \"slack.send_message\"; update/delete -> \"slack.update_message\" / \"slack.delete_message\"; advanced endpoint -> \"slack.api_request\".",
    "Zoom: list meetings -> \"zoom.list_meetings\"; create/update/delete -> \"zoom.create_meeting\" / \"zoom.update_meeting\" / \"zoom.delete_meeting\"; advanced endpoint -> \"zoom.api_request\".",
    "Google Drive: search -> \"google_drive.search_files\"; metadata -> \"google_drive.fetch_file_metadata\"; content -> \"google_drive.fetch_file_content\"; revisions -> \"google_drive.list_revisions\"; advanced endpoint -> \"google_drive.api_request\".",
    "HubSpot: search -> \"hubspot.search_records\"; record lookup -> \"hubspot.get_record\"; contact/deal writes -> \"hubspot.upsert_contact\" / \"hubspot.create_contact\" / \"hubspot.create_deal\" / \"hubspot.update_deal_stage\"; advanced endpoint -> \"hubspot.api_request\".",
    "QuickBooks: list -> \"quickbooks.list_invoices\" / \"quickbooks.list_customers\"; single invoice -> \"quickbooks.get_invoice\"; writes -> \"quickbooks.create_customer\" / \"quickbooks.create_invoice\" / \"quickbooks.send_invoice_reminder\" / \"quickbooks.update_invoice_safe_fields\"; advanced endpoint -> \"quickbooks.api_request\" (optionally with queryArgs.realmId).",
    "Stripe: customer list/get -> \"stripe.list_customers\" / \"stripe.get_customer\"; payment intent list/get -> \"stripe.list_payment_intents\" / \"stripe.get_payment_intent\"; refund create -> \"stripe.create_refund\"; advanced endpoint -> \"stripe.api_request\".",
    "Notion: page search/list -> \"notion.pages.search\" or \"notion.search\"; retrieve page -> \"notion.pages.retrieve\"; page property -> \"notion.pages.retrieve_property_item\"; page writes/archive -> \"notion.pages.create\" / \"notion.pages.update\" / \"notion.pages.archive\" / \"notion.pages.unarchive\"; block/content -> \"notion.blocks.retrieve\" / \"notion.blocks.list_children\" / \"notion.blocks.append_children\" / \"notion.blocks.update\" / \"notion.blocks.delete\"; database/data source -> \"notion.databases.retrieve\" / \"notion.databases.query\" / \"notion.databases.update\" / \"notion.data_sources.retrieve\" / \"notion.data_sources.query\"; comments -> \"notion.comments.list\" / \"notion.comments.create\".",
    "ClickUp: workspace list -> \"clickup.list_workspaces\"; task list/get -> \"clickup.list_tasks\" / \"clickup.get_task\"; task create/update -> \"clickup.create_task\" / \"clickup.update_task\"; advanced endpoint -> \"clickup.api_request\".",
    "monday.com: boards list -> \"monday.list_boards\"; board items -> \"monday.list_board_items\"; create item -> \"monday.create_item\"; update columns -> \"monday.change_item_column_values\"; advanced GraphQL -> \"monday.api_request\" with queryArgs.query/variables.",
    "Trello: boards list -> \"trello.list_boards\"; board cards -> \"trello.list_cards\"; card create/update -> \"trello.create_card\" / \"trello.update_card\"; advanced endpoint -> \"trello.api_request\".",
