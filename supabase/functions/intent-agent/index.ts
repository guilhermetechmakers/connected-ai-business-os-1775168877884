...
serve(async (req) => {
  ...
  const system = [
    ...
    "Stripe: customer list -> \"stripe.list_customers\"; payment intent list -> \"stripe.list_payment_intents\"; single payment intent -> \"stripe.get_payment_intent\"; refund write -> \"stripe.create_refund\".",
